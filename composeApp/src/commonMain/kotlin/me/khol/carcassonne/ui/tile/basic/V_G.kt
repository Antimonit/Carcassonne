...
val V_G = UiTile(
    ...
    shapes = mapOf(
        svgToShape(basic_tile_V_G_garden_svg) to V_G.garden,
        svgToShape(basic_tile_V_G_field_top_svg) to V_G.fieldTop,
        svgToShape(basic_tile_V_G_field_bottom_svg) to V_G.fieldBottom,
        svgToShape(basic_tile_V_G_road_svg) to V_G.road,
    ),
)
