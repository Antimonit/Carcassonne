...
class FieldFeaturesTest {
    ...
    fun `field features with completed cities`() {
        ...
        val newBoard = board
            .placeTile(Tiles.Basic.H.tile.rotated(Rotation.ROTATE_0).placed(0, -1), emptyList())
        ...
        assertEquals(
            expected = setOf(
                Field(
                    placedFields = setOf(
                        Tiles.Basic.D.fieldBottom.rotated(Rotation.ROTATE_0).placed(x = 0, y = 0),
                    ),
                    connectedCities = emptySet(),
                    figures = emptyList(),
                ),
                Field(
                    placedFields = setOf(
                        Tiles.Basic.D.fieldTop.rotated(Rotation.ROTATE_0).placed(x = 0, y = 0),
                    ),
                ...
                Field(
                    placedFields = setOf(
                        Tiles.Basic.H.field.rotated(Rotation.ROTATE_0).placed(x = 0, y = -1),
                    ),
                ...
                Field(
                    placedFields = setOf(
                        Tiles.Basic.E.field.rotated(Rotation.ROTATE_180).placed(x = 0, y = -2),
                    ),
    ...
    fun `field features can merge`() {
        val board = Board.starting(startingTile = Tiles.Basic.L.tile)
            .placeTile(Tiles.Basic.K.tile.rotated(Rotation.ROTATE_180).placed(0, 1), emptyList())

        assertEquals(
            expected = setOf(
                Field(
                    placedFields = setOf(
                        Tiles.Basic.L.fieldTop.rotated(Rotation.ROTATE_0).placed(0, 0),
                    ),
                    connectedCities = emptySet(),
                    figures = emptyList(),
                ),
                Field(
                    placedFields = setOf(
                        Tiles.Basic.L.fieldLeft.rotated(Rotation.ROTATE_0).placed(0, 0),
                        Tiles.Basic.K.fieldTop.rotated(Rotation.ROTATE_180).placed(0, 1),
                    ),
                    connectedCities = emptySet(),
                    figures = emptyList(),
                ),
                Field(
                    placedFields = setOf(
                        Tiles.Basic.L.fieldRight.rotated(Rotation.ROTATE_0).placed(0, 0),
                        Tiles.Basic.K.fieldBottom.rotated(Rotation.ROTATE_180).placed(0, 1),
                    ),
                    connectedCities = emptySet(),
                    figures = emptyList(),
                ),
            ...
            expected = setOf(
                Field(
                    placedFields = setOf(
                        ...
                        Tiles.Basic.L.fieldLeft.rotated(Rotation.ROTATE_0).placed(0, 0),
                        Tiles.Basic.K.fieldTop.rotated(Rotation.ROTATE_180).placed(0, 1),
                        Tiles.Basic.A.field.rotated(Rotation.ROTATE_270).placed(-1, 0),
                    ),
                    connectedCities = emptySet(),
                    figures = emptyList(),
                ),
    ...
    fun `field features with figures`() {
        val figureOne = PlacedFigure(
            placedElement = Tiles.Basic.E.field.rotated(Rotation.ROTATE_180).placed(0, -1),
            figure = PlayerFigures.greenMeeple,
        )
        val figureTwo = PlacedFigure(
            placedElement = Tiles.Basic.E.field.rotated(Rotation.ROTATE_180).placed(1, 0),
            figure = PlayerFigures.greenMeeple,
        )

        val board = Board.starting(startingTile = Tiles.Basic.E.tile)
            .placeTile(Tiles.Basic.E.tile.rotated(Rotation.ROTATE_180).placed(0, -1), listOf(figureOne))
            .placeTile(Tiles.Basic.E.tile.rotated(Rotation.ROTATE_180).placed(1, 0), listOf(figureTwo))
            .placeTile(Tiles.Basic.E.tile.rotated(Rotation.ROTATE_0).placed(1, -1), emptyList())
