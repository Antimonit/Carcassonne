...
import me.khol.carcassonne.ui.generated.resources.tile_basic_N
...
val N = UiTile(
    ...
    tile = Tiles.Basic.N.tile,
    uiElements = mapOf(
        Tiles.Basic.N.city to UiTile.UiElement(
            shape = svgToShape(basic_tile_N_city_svg),
            figurePlacement = Offset(0.75f, 0.25f),
        ),
        Tiles.Basic.N.field to UiTile.UiElement(
